...
class JPagination extends JObject
{
	...
	public function getLimitBox()
	{
		...
		else
		{
			$html = JHtml::_(
				...
				$limits,
				$this->prefix . 'limit',
				'class="inputbox product-list-selector" size="1" onchange="this.form.submit()"',
				'value',
				'text',
				$selected
			);
	...
	public function getCustomLimitBox(){
		$html = '';
		$params = '';
	...
	protected function _buildDataObject()
	{
		...
		for ($i = $this->get('pages.start'); $i <= $stop; $i++)
		{
			...
			if ($i != $this->get('pages.current') || $this->_viewall)
			{
				...
				$data->pages[$i]->link = JRoute::_($params . '&' . $this->prefix . 'limitstart=' . $offset) . '&limit=' . $limitNumber;
			}
		}
		return $data;
	}
